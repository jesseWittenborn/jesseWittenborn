...
# Quiz function to test user knowledge of subjects
	course = input("Welcome to Career Consultant! Do you enjoy Math, reading and writing, Science, or Communication?")
	if (course == "math"):
		print("Excellent answer the next question correctly for your prospective careers")	
		question1 = float(input("What are the first 3 digits of pi?"))
	
	
	
		if question1 == 3.14:
			print("Your prospective careers are as follows: Fincance, Engineering, and Business")
		else:
		...
		if (question2 == "biology"):
			print("Your prospective careers are as follows: Medicine, Biology, Anatomy")
		else:
			print("Incorrect Please try again or select a differant subject!")
		...
		if (question3 == "personification"):
			print("Your prospective careers are as follows: English, Journalism, Literature")
		else:
			print("Incorrect Please try again or select a differant subject!")
		...
		if (question4 == "negotiation"):
			print("Your prospective careers are as follows: Business, motivational Speaking, Project Management")
		else:
			print("Incorrect Please try again or select a differant subject!")
def main():
...
# Welcoming message and User input of which skill they enjoy
	...
	cccgrades()
	cccquiz()
	print("According to recent studies Business is the most common college major in America. Thank you for using Career Consultant to plan for your future!")
main()
